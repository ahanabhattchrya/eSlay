...
function changeUsername(value) { changePasswordInfo.username = value; }

function changeNewPassword(value) { changePasswordInfo.newPassword = value; }

function changeConfirmedNewPassword(value) { changePasswordInfo.newPasswordConfirmed = value; }
	...
	return (
        <div className="change-password form-container">
			<Box className="form-box change-password-box" sx={{ border: "3px solid black", borderRadius: 2 }}>
                ...
                <TextField type={"password"} required id="outlined-required" label="New Password Confirmation" variant="outlined" onChange={event => changeConfirmedNewPassword(event.target.value)} />
